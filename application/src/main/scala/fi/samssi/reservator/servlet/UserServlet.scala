...
import fi.samssi.reservator.service.{EmailService, UserRepository}
...
class UserServlet @Inject()(userRepository: UserRepository, emailService: EmailService) extends MasterServlet with Logging {
  post("/login") {
